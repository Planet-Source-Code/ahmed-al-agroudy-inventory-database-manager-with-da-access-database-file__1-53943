...
Begin VB.Form FindItemInTV 
   ...
   Begin VB.Label Label2 
      Caption         =   "Type  first few letters of the Account Name your looking for «ﬂ » «·«Õ—› «·«Ê·Ï „‰ «”„ «·Õ”«» «·–Ì  »ÕÀ ⁄‰Â"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   178
...
If CancelFind Then
  ...
  Else
    ...
    If i = AccTreeView.TreeView1.Nodes.Count And Finditem = True Then
         xmsg = MsgBox("The specified region has been searched, Nothing follows. " & vbCrLf & _
                     "Œ’Ì’ Â–« «·Õﬁ· ·»ÕÀ ·«‘Ì¡ ", vbInformation + vbOKOnly, "Message —”«·… ")
         i = 1
         Exit Sub
    End If
  ...
  If Finditem = False Then
    i = 1
    CancelFind = False
    xmsg = MsgBox("Walang makita pare(Mafi Shof Sadik)·«ÌÊÃœ  ", vbInformation + vbOKOnly, "Message —”«·… ")
    AccTreeView.TreeView1.Nodes.Item(i).Selected = True
   Else
   i = 1
   CancelFind = False
   xmsg = MsgBox("The specified region has been searched Œ’Ì’ Â–« «·Õﬁ· ·»ÕÀ  ", vbInformation + vbOKOnly, "Message—”«·…")
   AccTreeView.TreeView1.Nodes.Item(i).Selected = True
  End If
End If
End Sub
