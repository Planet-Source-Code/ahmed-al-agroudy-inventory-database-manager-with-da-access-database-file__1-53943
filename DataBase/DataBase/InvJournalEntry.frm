...
Begin VB.Form InvJournalEntry 
   Caption         =   "Inventory Journal Entry   ≈œŒ«· ﬁÌÊœ «·ÌÊ„Ì… "
   ClientHeight    =   8490
   ClientLeft      =   75
   ClientTop       =   -12960
   ClientWidth     =   8880
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TabCaption(0)   =   "Inventory List ﬁ«∆„… «·„Œ“Ê‰"
   ...
   Begin VB.Menu Main 
      ...
      Begin VB.Menu xDownLoad 
         Caption         =   "Download Items Taken... Õ„Ì· «·«’‰«› "
      End
      Begin VB.Menu eEdit 
         Caption         =   "Modify/Edit  «÷«›… "
      End
   ...
   Begin VB.Menu Main2 
      ...
      Begin VB.Menu DElSelectitem 
         Caption         =   "Delete Selected Item «·€«¡  Ã„Ì⁄ «·√’‰«› "
      End
      Begin VB.Menu PrintItem 
         Caption         =   "Print items ÿ»«⁄… «·«’‰«› "
      End
      Begin VB.Menu Fv 
         Caption         =   "Full View —ƒÌ ⁄«„… "
      End
   End
End
...
Me.caption = "Inventory Journal Entry   ≈œŒ«· ﬁÌÊœ «·ÌÊ„Ì… " & "//" & catName
DrCat = catName
End Sub
