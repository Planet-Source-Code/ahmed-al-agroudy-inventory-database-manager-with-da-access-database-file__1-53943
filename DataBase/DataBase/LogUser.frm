...
Begin VB.Form LogUser 
   ...
   Caption         =   "Enter User Name and Password  «œŒ«· «”„ «·„” Œœ„ Ê«”„ «·”—Ì"
   ClientHeight    =   1575
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5190
...
If Trim(Me.Combo1) = "" Then
    mess = MsgBox("Enter User Name «œŒ«· «”„ «„” Œœ„  ", vbInformation + vbOKOnly, "Message —”«·…")
    Me.Combo1.SetFocus
    Exit Sub
End If
...
If rstUser.EOF = True Then
    mess = MsgBox("Unauthorized user ·«Ì—Œ’ ··„” Œœ„  ", vbInformation + vbOKOnly, "Message —”«·…")
    Me.Combo1.SetFocus
    rstUser.close
    Exit Sub
  Else
    ...
    If Trim(rstUser!Pwd) = Trim(Me.Text1) Then
       ...
       Unload Me
      Else
      mess = MsgBox("Invalid Password —ﬁ„ «·”—Ì Œÿ«", vbInformation + vbOKOnly, "Message —”«·…")
      rstUser.close
      Me.Text1.SetFocus
    End If
End If
