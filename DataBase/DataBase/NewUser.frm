...
Begin VB.Form NewUser 
   ...
   Begin VB.Label Label5 
      Caption         =   "&Duration in Days »ﬁ«¡ ›Ì «·ÌÊ„ "
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   178
...
If Trim(Me.Combo1) = "" Then
    msg = MsgBox("User Name must not be blank «”„ «·„” Œœ„ ·« Ì⁄„· ", vbExclamation + vbOKOnly, "Message")
    Me.Combo1.SetFocus
    Exit Sub
End If
If Trim(Me.Text1.Text) <> Trim(Me.Text2.Text) Then
    msg = MsgBox("Confirmed Password does not match against the Password" & vbCrLf & _
                 "«ﬂœ «·«”„ «·”—Ì Ê·«  ⁄Ìœ «·„ÕÊ·…  ", vbExclamation + vbOKOnly, "Message —”«·… ")
    Me.Text2.SetFocus
    Exit Sub
End If
If Me.Check1.Value = 0 And Trim(Me.Combo3.Text) = "" Then
    msg = MsgBox("Enter Duration in Days«œŒ«· «·»ﬁ«¡ ›Ì «·«Ì«„ ", vbExclamation + vbOKOnly, "Message")
    Me.Combo3.SetFocus
    Exit Sub
End If
If Trim(Me.Combo2) = "" Then
    msg = MsgBox("Select what User's Role „‰ ›÷·ﬂ „«ÂÌ ÊŸÌ›… «·„” Œœ„ ", vbExclamation + vbOKOnly, "Message")
    Me.Combo2.SetFocus
    Exit Sub
End If

mss = MsgBox("Do you want to Register now this new User?Â·  —Ìœ «·«‘ —«ﬂ ›Ì Â–« «·„” Œœ„ «·ÃœÌœ  ", vbQuestion + vbYesNoCancel, "Please confirm „‰ ›÷·ﬂ «· «ﬂÌœ ")
If mss = 6 Then
    ...
    If rstUser.EOF = False Then
        msg = MsgBox("User already exist!«·„” Œœ„ ÌﬂÊ‰ Õ›Ÿ" & vbCrLf & _
