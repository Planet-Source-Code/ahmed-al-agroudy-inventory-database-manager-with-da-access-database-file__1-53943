...
Begin VB.Form SCMenu 
   ...
   Begin VB.Menu xMain 
      ...
      Begin VB.Menu xview 
         Caption         =   "View      ⁄—÷"
         Begin VB.Menu Li 
            Caption         =   "Large Icons           √ÌﬁÊ‰«  ﬂ»Ì—…"
            Checked         =   -1  'True
         End
         Begin VB.Menu SI 
            Caption         =   "Small Icons          √ÌﬁÊ‰«  ’€Ì—…"
         End
         Begin VB.Menu List 
            Caption         =   "List                                   ⁄—÷"
         End
   ...
   Begin VB.Menu Lv 
      ...
      Begin VB.Menu xdelete 
         Caption         =   "&Delete Selected item    «·€«¡ «·ÿ—› «·„Ÿ··"
      End
      Begin VB.Menu xPrint 
         Caption         =   "&Print Entries      ÿ»«⁄… «·ÿ—› «·„Ÿ··"
      End
      Begin VB.Menu FV 
         Caption         =   "&Full View"
      End
...
With Me.CommonDialog1
    ...
    .DialogTitle = "Open Picture for Ledger Background ◊ÕÀÏ ∫Âƒ⁄ﬁÀ »Œﬁ /ÀÌ·Àﬁ ·¬‘ƒ‰·ﬁŒ⁄ÏÌ"
...
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "A", "TN »Ì»Ì”", 600)
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "b", "Account No.—ﬁ„ «·Õ”«» ", 2100)
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "c", "AccountName —ﬁ„ «·Õ”«» ", 2000)
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "d", "Trans Date À’÷ﬁ", 1550)
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "e", "Debit À’÷ﬁ", 1200)
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "f", "Credit À’÷ﬁ", 1200)
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "g", "SerialNo  ›«’Ì·", 1100)
'Set xcol = Mainform.ListView1.ColumnHeaders.Add(, "i", "Details  ›«’Ì·", 2000)
