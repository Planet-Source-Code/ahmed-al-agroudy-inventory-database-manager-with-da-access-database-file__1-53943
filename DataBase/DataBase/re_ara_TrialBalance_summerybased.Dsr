VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} re_ara_TrialBalance_summerybased 
   Bindings        =   "re_ara_TrialBalance_summerybased.dsx":0000
   Caption         =   "Trial Balance Summary Based     >>     „Ì“«‰ «·„—«Ã⁄… »«·√—’œ… "
   ClientHeight    =   8490
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   11880
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item12 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   1710
         Object.Height          =   1590
         Picture         =   "re_ara_TrialBalance_summerybased.dsx":0016
      EndProperty
      ItemType13      =   3
   ...
   EndProperty
End
Attribute VB_Name = "re_ara_TrialBalance_summerybased"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Private Sub DataReport_Initialize()
'dataanu.trial_balance_summery "a"
'End Sub
