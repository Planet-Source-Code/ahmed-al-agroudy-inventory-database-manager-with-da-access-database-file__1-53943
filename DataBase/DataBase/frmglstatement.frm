...
Begin VB.Form frmglstatement 
   ...
   Caption         =   "General Ledger Balance  √—’œ… «·«” «– «·⁄«„"
   ClientHeight    =   6390
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8055
...
Dim dfrom As Date
Dim dto As Date
allword = "›Ì ‰Â«Ì… ÌÊ„  " & DatePart("yyyy", Format(dtpto.Value, "dd/mm/yyyy")) & "/" & DatePart("m", Format(dtpto.Value, "dd/mm/yyyy")) & "/" & DatePart("d", Format(dtpto.Value, "dd/mm/yyyy"))
