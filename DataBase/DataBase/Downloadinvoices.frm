...
Begin VB.Form DownLoadinvoices 
   ...
   Begin VB.Label Label1 
      Caption         =   "Downloading Sales Invoices....  Õ„Ì· ›Ê« Ì— «·„»Ì⁄« "
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   178
...
If CancelDownLoading Then
  ...
  Else
    ...
    If CancelDownLoading = False Then
      ...
      Else
      Beep
       mess = MsgBox("Finished downloading «‰ Â«¡ «· Õ„Ì·!  " & cFound & " Found(s)ÌÃœ ", vbInformation + vbOKOnly, "Message")
       i = 0
       cVal = 0
       CancelDownLoading = False
       Me.Command2.Visible = False
       ...
       'UpdateClientCode
       Me.Label1.caption = "Now Generating Sales Journal...«·«‰ ÌÊ„Ì… «·Õ”«»«  «·⁄«„…"
...
If rsInv2.EOF = False And cVal <> 0 Then
     mess = MsgBox("Are you sure you want to cancel downloading?" & vbCrLf & _
           " Â· «‰  „ «ﬂœ „‰ «·€«¡ «· Õ„Ì· ", vbQuestion + vbYesNo, "Please confirm „‰ ›÷·ﬂ «· «ﬂÌœ")
    If mess = vbNo Then
        Cancel = -1
        'SendKeys "{Enter}"
      Else
