...
Begin VB.Form DownLoadIVY 
   ...
   Begin VB.Label Label1 
      Caption         =   "Downloading Inventory Items... Õ„Ì· «’‰«› «·„Œ“Ê‰ "
      BeginProperty Font 
...
If CancelDownLoading Then
  ...
  Else
    ...
    If CancelDownLoading = False Then
      ...
      Else
      Beep
       mess = MsgBox("Finished downloading! " & Str(Taken) & " item(s) found " & "  «‰ Â«¡ «· Õ„Ì·", vbInformation + vbOKOnly, "Message")
       CancelDownLoading = False
       i = 0
       cVal = 0
       rsIvy2.Close
...
End If
InvJournalEntry.caption = "Inventory Journal Entry   ≈œŒ«· ﬁÌÊœ «·ÌÊ„Ì… "
