    ...
    On Error Resume Next
        ...
        If (DayNo + 1) <= Me.ListView1.ListItems.Count Then
          If Me.Check1.Value = 0 Then
           mess = MsgBox(Me.ListView1.ListItems.Item(DayNo) & " Transaction is Finished! «·⁄„·Ì«  «·‰Â«∆Ì…  " & vbCrLf _
                      & "Do you want to continue for the " & Me.ListView1.ListItems.Item(DayNo + 1) & " transactions?", vbQuestion + vbYesNo, "Please confirm „‰ ›÷·ﬂ «· «ﬂÌœ")
           Else
           mess = vbYes
          End If
        Else
          ...
          DayNo = 0
          Me.Label1.caption = "Status: Succesfully posted! ·’ﬁ »‰Ã«Õ"
          Exit Sub
        End If
        If mess = vbYes Then
            OpenJOurnals
