...
Begin VB.Form FrmPayableSetup 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdPrintPayReq 
         Caption         =   "Print Payment &Request  ÿ»«⁄… ÿ·» «·„œ›Ê⁄«  "
         Height          =   375
         Left            =   8400
         TabIndex        =   138
         Top             =   240
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TabCaption(0)   =   "Payable Entry  «œŒ«· «·„œ›Ê⁄«   "
      ...
      TabCaption(3)   =   "Paid Voucher ›« Ê—… «·„œ›Ê⁄«  "
      ...
      Begin VB.CommandButton Command3 
         Caption         =   "Go &Purchase Setup  Õ„Ì· «·„‘ —Ì«  "
         Enabled         =   0   'False
         Height          =   375
         Left            =   8400
         TabIndex        =   64
      ...
      Begin VB.CommandButton Command2 
         Caption         =   "&Go Payment Analysis   Õ·Ì· «·„œ›Ê⁄«  "
         Height          =   375
         Left            =   8400
         TabIndex        =   55
         Top             =   5880
      ...
      Begin VB.Label Label31 
         AutoSize        =   -1  'True
         Caption         =   "Total Paid Vouchers  ≈Ã„«·Ï «·„œ›Ê⁄«  "
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   178
      ...
      Begin VB.Label Label30 
         AutoSize        =   -1  'True
         Caption         =   "Un Confirmed List     «·€Ì— „ƒﬂœ"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   178
...
If cmdPrintPayReq.caption <> "Print Payment &Request  ÿ»«⁄… ÿ·» «·„œ›Ê⁄«  " Then
...
'RstRepo.Close
cmdPrintPayReq.caption = "Print Payment &Request  ÿ»«⁄… ÿ·» «·„œ›Ê⁄«  "
'cmdPrintPayReq.Visible = False
...
Set xcol = Me.ListView2.ColumnHeaders.Add(, , "Rate «·«ÌÃ«—", 800)
Set xcol = Me.ListView2.ColumnHeaders.Add(, , "Description «·Ê’›  ", 2050)
Set xcol = Me.ListView2.ColumnHeaders.Add(, , "Days «·«Ì«„ ", 800)
Set xcol = Me.ListView2.ColumnHeaders.Add(, , "Mode «·‰Ê⁄  ", 850)
Set xcol = Me.ListView2.ColumnHeaders.Add(, , "Level «·„” ÊÌ ", 850)


Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Number «·—ﬁ„ ", 1200)
Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Date «· «—ÌŒ  ", 1200)
Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Payee «·œ›⁄ ", 3000)
Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Due Date ÌÊ„ «·„” Õﬁ ", 1200)
Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Requester«·„ÿ·Ê» ", 1500)
Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Status", 900)
Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Journalised", 1000)
Set xcol = Me.ListView1.ColumnHeaders.Add(, , "Amount «·«Ã„«·Ì ", 1100, lvwColumnRight)

Me.ListView1.ColumnHeaders(5).Alignment = lvwColumnRight

Set xcol = Me.ListView7.ColumnHeaders.Add(, , "Number «·—ﬁ„ ", 1200)
Set xcol = Me.ListView7.ColumnHeaders.Add(, , "Date «· «—ÌŒ  ", 1300)
Set xcol = Me.ListView7.ColumnHeaders.Add(, , "Supplier «·„Ê—œ ", 4300)
Set xcol = Me.ListView7.ColumnHeaders.Add(, , "Due Date ÌÊ„ ·„” Õﬁ ", 1400)
Set xcol = Me.ListView7.ColumnHeaders.Add(, , "Requester «·„ÿ·Ê»", 1500)
Set xcol = Me.ListView7.ColumnHeaders.Add(, , "Amount «·«Ã„«·Ì ", 1400, lvwColumnRight)

Me.ListView7.ColumnHeaders(5).Alignment = lvwColumnRight


Set xcol = Me.ListView4.ColumnHeaders.Add(, , "Number «—ﬁ„ ", 1400)
Set xcol = Me.ListView4.ColumnHeaders.Add(, , "Date «· «—ÌŒ ", 1300)
Set xcol = Me.ListView4.ColumnHeaders.Add(, , "Supplier «·„Ê—œ ", 4000)
Set xcol = Me.ListView4.ColumnHeaders.Add(, , "Account «·Õ”«» ", 2600)
Set xcol = Me.ListView4.ColumnHeaders.Add(, , "Amount «·«Ã„«·Ì ", 1800, lvwColumnRight)

Set xcol = Me.ListView5.ColumnHeaders.Add(, , "Number «·—ﬁ„ ", 1400)
Set xcol = Me.ListView5.ColumnHeaders.Add(, , "Date «· «—ÌŒ ", 1300)
Set xcol = Me.ListView5.ColumnHeaders.Add(, , "Supplier «·„Ê—œ ", 3900)
Set xcol = Me.ListView5.ColumnHeaders.Add(, , "Requester «·„ÿ·Ê»", 2300)
Set xcol = Me.ListView5.ColumnHeaders.Add(, , "Amount «·«Ã„«·Ì ", 1400, lvwColumnRight)

Set xcol = Me.ListView8.ColumnHeaders.Add(, , "JounalNo —ﬁ„ «·ÌÊ„Ì… ", 1400)
Set xcol = Me.ListView8.ColumnHeaders.Add(, , "Ticket No —ﬁ„ «·ﬁÌœ ", 1300)
Set xcol = Me.ListView8.ColumnHeaders.Add(, , "Date Confirmed  «—ÌŒ «· «ﬂÌœ ", 1300)
Set xcol = Me.ListView8.ColumnHeaders.Add(, , "AccountcodeﬂÊœ «·Õ”«» ", 1300)
Set xcol = Me.ListView8.ColumnHeaders.Add(, , "AccountName «”„ «·Õ”«» ", 3000)
Set xcol = Me.ListView8.ColumnHeaders.Add(, , "Debit «·„œÌ‰ ", 1400, lvwColumnRight)
Set xcol = Me.ListView8.ColumnHeaders.Add(, , "Credit «·œ«∆‰ ", 1400, lvwColumnRight)
...
txtBranch.AddItem "Obuor ⁄»Ê—"
txtBranch.AddItem "Arcadia «—ﬂ«œÌ« "

cmbPaymode.AddItem "Cash «·‰ﬁœÌ"
cmbPaymode.AddItem "Check «·‘Ìﬂ "
cmbPaymode.AddItem "Bank Transfer "

txtTMmode.AddItem "Cash «·‰ﬁœÌ "
txtTMmode.AddItem "Check «·‘Ìﬂ "

txtTMDes.AddItem "On Delevary ⁄‰œ «· ”·Ì„ "
txtTMDes.AddItem "After Delevary »⁄œ «· ”·Ì„ "
txtTMDes.AddItem "When Shipping ⁄‰œ„« «· ”ÊÌﬁ "
txtTMDes.AddItem "Invoice Time Êﬁ  «·›« Ê—… "
...
If cDay > 31 Or cDay < 1 Then
    mess = MsgBox("Invalid Date  «—ÌŒ Œÿ«", vbInformation + vbOKOnly, "Message")
    Me.MskDate.SetFocus
  ElseIf cMonth > 12 Or cMonth < 1 Then
    mess = MsgBox("Invalid Month ‘Â— Œÿ«", vbInformation + vbOKOnly, "Message")
    Me.MskDate.SetFocus
ElseIf cYear < 1900 Or cYear > Year(Date) Then
    mess = MsgBox("Invalid Year”‰… Œÿ«", vbInformation + vbOKOnly, "Message")
    Me.MskDate.SetFocus
End If
...
MsgBox "Amount Paid can not be more than the Invoice Amount «Ã„«·Ì «·„œ›⁄ ·«Ì”«ÊÌ «Ã„«·Ì «·›« Ê—… ", vbCritical, "Error"
Exit Sub
End If
txtRefNo_LostFocus
End Sub
...
'This will save the additional field to the file insted of saving all the available datas in the listbox
xok = MsgBox("Do you want to Add the Term details Â·  —Ìœ «÷«›… ‘—Êÿ  ›«’Ì·Ì… ", vbOKCancel, "SAVE")
If xok = vbOK Then
'Save
      With rstterm
      .addnew
