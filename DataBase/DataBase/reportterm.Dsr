VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} reportterm 
   Bindings        =   "reportterm.dsx":0000
   Caption         =   "Term Report"
   ClientHeight    =   8595
   ClientLeft      =   165
   ClientTop       =   450
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item11 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Payment Terms As of"
      EndProperty
      ItemType12      =   3
   ...
   EndProperty
End
Attribute VB_Name = "reportterm"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Activate()
dataanu.rscommandterm.Requery
End Sub
