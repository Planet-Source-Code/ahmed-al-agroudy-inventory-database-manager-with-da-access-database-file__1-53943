...
Begin VB.Form NewAccts 
   ...
   Begin VB.Label Label2 
      Caption         =   "Click right mouse button to select options «÷€ÿ Ì„Ì‰ «·›«—… ·Œ Ì«— «·ÊŸ«∆›"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   178
...
End If
   ...
   If cErr = 380 Then
       ...
       mess = MsgBox("I'm going to click first the Back Button now in order to refresh the list" & vbCrLf & _
                      "”Ê› «–Â» ·÷€ÿ «Ê·« “— · ÕœÌÀ  «·ﬁ«∆„…", vbInformation + vbOKOnly, "Message —”«·…")
       Call Command1_Click
       Call Command2_Click
       Exit Sub
    End If
...
If Me.ListView1.ListItems.Count <> 0 Then
    ...
    If FormNo > 3 And FormNo < 7 Then
      ...
      If xRem = "Main" Then
        ...
        mess = MsgBox("This is the Main Account and nothing follows" & vbCrLf & _
                       "Â–Â  ﬂÊ‰ ﬁ«∆„… «·Õ”«»«  Ê·« ÌÊÃœ ‘Ì¡ ", vbInformation + vbOKOnly, "Message —”«·… ")
        Exit Sub
      End If
     End If
    ...
    If FormNo = 7 Then
        ...
        mess = MsgBox("This is the Last Level of the Chart of Account" & vbCrLf & _
                      "Â–« ÌﬂÊ‰ «Œ— „” ÊÌ›Ì ÃœÊ· «·Õ”«»«   ", vbInformation + vbOKOnly, "Message —”«·…")
        Exit Sub
    End If
...
If FormNo = 1 Then
 ...
 If UCase(WhatLevel) = UCase("TOpLevel") Then
    Newform.caption = "Financial Position Category ›∆«  ÊŸ«∆› «·Õ”«»«   "
 Else
...
Set xcol = Newform.ListView1.ColumnHeaders.Add(, "a", "AccountName(Englisi) «”„ «·Õ”«» «‰Ã·Ì“Ì ", 2500)
Set xcol = Newform.ListView1.ColumnHeaders.Add(, "b", "AccountName(Arabi)«”„ «·Õ”«» »«·⁄—»Ì", 2630)
Set xcol = Newform.ListView1.ColumnHeaders.Add(, "c", "Sub-Level# „” ÊÌ À«‰ÊÌ", 1000)
Set xcol = Newform.ListView1.ColumnHeaders.Add(, "d", "AccountCode ﬂÊœ «·Õ”«»«  ", 1740)
Set xcol = Newform.ListView1.ColumnHeaders.Add(, "e", "Remarks „·«ÕŸ«  ", 2000)
...
Newform.Label3 = Newform.ListView1.ListItems.Count & " Total item(s) found! ÌÃœ „Ã„Ê⁄ «·«’‰«› "
Newform.Show 1
...
If xCountry = "" Then
    ...
    Set xcol = Me.ListView1.ColumnHeaders.Add(, "a", "Country »·œ", 4000)
    Set xcol = Me.ListView1.ColumnHeaders.Add(, "b", "Code ﬂÊœ", 1000)
    Do Until rst.EOF
...
Private Sub Form_Unload(Cancel As Integer)
 If CancelAll = False Then
    msgs = MsgBox("Are you sure you want to Close?Â· «‰  „ «ﬂœ „‰ «·€·ﬁ  ", vbQuestion + vbYesNo, "Please confirm „‰ ›÷·ﬂ «· «ﬂÌ")
 Else
  Unload Me
 Exit Sub
End If
...
If oldstring <> xNewstring Then
  mess = MsgBox("Do you want to save changes?Â·  —Ìœ Õ›Ÿ «· €Ì—«  ", vbOKCancel + vbQuestion, "Please confirm „‰ ›÷·ﬂ «· «ﬂÌœ")
  If mess = vbOK Then
    On Error Resume Next
...
Else
 ...
 Me.RenameArabName.caption = "Rename «⁄«œ… «·«”„"
End If
Newform.ListView1.Sorted = True
CountryIndex:
...
If WhatColumnclick = 1 Then
  ...
  RenArabName.Label3 = "AccountName Arab «”„ «·Õ”«» »«·⁄—»Ì"
