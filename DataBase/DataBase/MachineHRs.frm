...
Begin VB.Form MachineHRs 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      EndProperty
      TabCaption(0)   =   "New/Edit Hour Used «œŒ«· ”«⁄«  «·„” Œœ„ "
      ...
      TabCaption(1)   =   "List of Hours Used  ﬁ«∆„… ”«⁄«  «·„” Œœ„"
...
ASsetNo = AssetSetup.ListView1.SelectedItem
    ...
    If rsActivityBase.EOF = True Then
        msg = MsgBox("Do you want to save your entry?Â·  —Ìœ Õ›Ÿ «·»Ì«‰«  ", vbQuestion + vbYesNo, "PLease confirm „‰ ›÷·ﬂ")
        If msg = vbYes Then
            With rsActivityBase
                .addnew
                !ASsetNo = ASsetNo
      ...
      Else
       msg = MsgBox("Do you want to save changes? Â·  —Ìœ Õ›Ÿ «· €Ì—«  ", vbQuestion + vbYesNo, "PLease confirm „‰ ›÷·ﬂ")
        If msg = vbYes Then
        With rsActivityBase
            !ASsetNo = ASsetNo
            !AssetCode = (AssetSetup.ListView1.SelectedItem.SubItems(1))
...
If cDay > 31 Or cDay < 1 Then
    mess = MsgBox("Invalid Date »Ì«‰«  Œÿ«", vbInformation + vbOKOnly, "Message —”«·…")
    Me.MaskEdBox1.SetFocus
