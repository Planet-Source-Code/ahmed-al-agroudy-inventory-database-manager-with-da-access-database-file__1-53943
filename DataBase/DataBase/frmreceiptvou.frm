...
If recfindacc.BOF = True Then
    recfindacc.close
    MsgBox "Please choose the Correct Account Number" & vbCrLf & " „‰ ›÷··ﬂ «Œ — —ﬁ„ «·Õ”«» «·’ÕÌÕ", vbInformation, "Invalid Account Number"
    ccname.SetFocus
    Exit Sub
Else
...
If MsgBox("Select the Language to Print      «Œ «— ·€… «·ÿ»«⁄…  " & vbCrLf & "Yes :- For Arabic                                       »«·⁄—»Ì " & vbCrLf & "No  :- For English                                  »«·«‰Ã·Ì“Ì", vbInformation + vbYesNo, "Language Option  «Œ Ì«— «··€…") = vbYes Then
...
Else
    classamount.ArabicAmountInWords AmtInFigure, AmtInwords, "—Ì«·", "Â··Â"
End If
...
Printer.Print Tab(22); "Official Receipt No.:-  "; addzero & Trim(txtreceiptnumber.Text); "  ”‰œ ﬁ»÷  "
...
Printer.FontBold = True
Printer.Print Tab(65 - Len("..... «· «—ÌŒ")); "..... «· «—ÌŒ";
...
Printer.FontBold = True
Printer.Print Tab(132 - Len("..... «·„»·€ »«·Õ—Ê›")); "..... «·„»·€ »«·Õ—Ê›"
Printer.FontSize = 2
Printer.Print ""
...
End If
Printer.FontBold = True
Printer.Print Tab(133 - Len("....... ‰Ê⁄ «·œ›⁄ ")); "....... ‰Ê⁄ «·œ›⁄"
Printer.FontSize = 2
Printer.Print ""
    ...
    Printer.FontBold = True
    Printer.Print Tab(133 - Len("..... «·ÌÊ„ „” Õﬁ  «—ÌŒ")); "..... «·ÌÊ„ „” Õﬁ  «—ÌŒ"
    Printer.FontSize = 10
...
End If
Printer.FontBold = True
Printer.Print Tab(133 - Len("....... «·œ›⁄ „ﬁ«»·")); "....... «·œ›⁄ „ﬁ«»·"
Printer.FontBold = False
...
Printer.FontSize = 10
Printer.Print Tab(13); "  (Manager/«·„œÌ—)    "; Tab(51); "     (Auditor/«·„—«Ã⁄)    "; Tab(92); "     (Cashier/√„Ì‰ «·’‰œÊﬁ)    "
'Printer.Print ""
Printer.FontSize = 6
Printer.Print ""
...
On Error GoTo er:
Printer.EndDoc
MsgBox "Receipt Voucher Printed Successfully" & vbCrLf & "  „ «·ÿ»⁄ »‰Ã«Õ ", vbInformation, "Print Conformation"

er:
If Err.Number = 482 Then
    If MsgBox("Please check your Printer, Turn ON And Press Yes." & vbCrLf & " —«Ã⁄ «·ÿ«»⁄Â .«› ÕÂ« Ê«÷€ÿ „Ê«›ﬁ", vbYesNo, "Not Ready") = vbYes Then
        cmdPrint_Click
    Else
        Exit Sub
    End If
...
MsgBox "Record Updated Successfully" & vbCrLf & "   „ «·Õ›Ÿ", vbInformation, "Data Saved"
cmdPrint_Click
cmdsave.Enabled = True
Printer.FontItalic = False
'ProgressBar1.Visible = False
...
Me.caption = "Receipt Voucher...                                                                                                                                                ”‰œ ﬁ»÷  "
cc = 0
...
If Val(Trim(Mid(Trim(comsetmode.Text), 1, 6))) = 2 Or Val(Trim(Mid(Trim(comsetmode.Text), 1, 6))) = 5 Then
    MsgBox "Please This Method is Not Available" & vbCrLf & " Â–Â «·Œ«’ÌÂ €Ì— „ «ÕÂ", vbInformation, "Invalid MOde"
...
'  Else
'  txtamountinword = "Can't create amount in words because amount in figure exceeding 21Million" & vbCrLf & "  «·„»·€ √ﬂÀ— „‰ 21 „·ÌÊ‰ ·« Ì„ﬂ‰  ÕœÌÀ «·Õﬁ·"
'End If
...
recchecktemp.Open "Select * from vouchers where tempinvoice =" & "'" & Trim(txttempreceipt.Text) & "'", CON1, adOpenKeyset, adLockOptimistic
    If recchecktemp.BOF = True Then
        ...
        'comreceivedfrom.SetFocus
    Else
        MsgBox "Please check Your Temporary Voucher Number is Repeating" & vbCrLf & "  Â–« «·—ﬁ„  „ «œŒ«·Â „‰ ﬁ»· «Œ — —ﬁ„ «Œ—", vbInformation, "Repeating Number"
        recchecktemp.close
        txttempreceipt.Text = ""
        txttempreceipt.SetFocus
        Exit Sub
