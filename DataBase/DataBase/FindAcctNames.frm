...
Begin VB.Form FindAcctNames 
   ...
   Caption         =   "Find AccountNames  «·»ÕÀ ⁄‰ Õ”«»"
   ClientHeight    =   4545
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9630
   ...
   Begin VB.Label Label2 
      ...
      Caption         =   "Type any few letters of the accountName you're looking for.«œŒ· «Õ—› ﬁ·Ì·… „‰ «”„ «·Õ”«» «·–Ì  Êœ «·»ÕÀ ⁄‰Â:"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   178
