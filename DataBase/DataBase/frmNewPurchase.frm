...
If cmdsave.caption = "&Culculate «·Â Õ«”»… " Then
  If Check1.Value = 0 Then
'cmdSave.Caption = "&Save to Payable Setup Õ›Ÿ  Õ„Ì· «·„œ›Ê⁄«  "
