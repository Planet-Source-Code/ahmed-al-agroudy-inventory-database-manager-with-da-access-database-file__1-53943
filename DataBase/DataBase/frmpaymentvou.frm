...
'this is for different menues
    Printer.Print Tab(22); "Disbursement Voucher No.:-  "; addzero & Trim(txtreceiptnumber.Text); "  ”‰œ ’—›  "
...
Printer.FontBold = True
Printer.Print Tab(133 - Len("..... «·„»·€ »«·Õ—Ê›")); "..... «·„»·€ »«·Õ—Ê›"
Printer.FontSize = 2
Printer.Print ""
...
End If
Printer.FontBold = True
Printer.Print Tab(132 - Len("..... ‰Ê⁄ «·œ›⁄")); "..... ‰Ê⁄ «·œ›⁄"
Printer.FontSize = 2
Printer.Print ""
...
Printer.FontSize = 10
    If (Trim(Mid(Trim(cmbpaymenttype.Text), 1, 3)) = "03" Or Trim(Mid(Trim(cmbpaymenttype.Text), 1, 3)) = "02") And (Trim(Mid(Trim(comsetmode.Text), 1, 3)) <> "006" And Trim(Mid(Trim(comsetmode.Text), 1, 3)) <> "500") Then
        ...
        Printer.FontBold = True
        Printer.Print Tab(133 - Len("..... «·ÌÊ„ „” Õﬁ «·œ›⁄")); "..... «·ÌÊ„ „” Õﬁ «·œ›⁄"
    Else
...
End If
Printer.FontBold = True
Printer.Print Tab(133 - Len("..... „ﬁ«»· «·œ›⁄")); "..... „ﬁ«»· «·œ›⁄"
Printer.FontBold = False
Printer.Print ""
Printer.FontBold = True
...
Printer.FontSize = 10
Printer.Print Tab(13); "   (Payee/«·„œ›Ê⁄ ·Â˛)    "; Tab(53); "   (Manager/«·„œÌ—)    "; Tab(92); "     (Cashier/√„Ì‰ «·’‰œÊﬁ)    "
On Error GoTo er
Printer.EndDoc
MsgBox "Voucher Printed Successfully   „ «·ÿ»⁄ »‰Ã«Õ", vbInformation, "Print Conformation"

er:
If Err.Number = 482 Then
    If MsgBox("Please check your Printer And Turn ON And Press Yes." & vbCrLf & "  —«Ã⁄ «·ÿ«»⁄Â . «› ÕÂ« Ê«÷€ÿ „Ê«›ﬁ", vbYesNo, "Not Ready") = vbYes Then
        cmdPrint_Click
    Else
        Exit Sub
    End If
...
If Val(Trim(Mid(Trim(comsetmode.Text), 1, 6))) = 2 Or Val(Trim(Mid(Trim(comsetmode.Text), 1, 6))) = 5 Then
    If recpayable.BOF = True Then
        MsgBox "No Any Confirmed Payables Available " & vbCrLf & "  ·«  ÊÃœ Õ—ﬂÂ »«·„Ê«›ﬁ«  ··’—› . « ’· »«·Õ”«»« ", vbInformation, "Invalid Number"
        txtinvoicenum.Text = ""
    ...
    If okcontinue <> 1 Then
        MsgBox "This Number is Not Approved " & vbCrLf & " Â–« «·—ﬁ„ ·„ ÌÊ«›ﬁ ⁄·ÌÂ ", vbInformation, "Invalid Number"
