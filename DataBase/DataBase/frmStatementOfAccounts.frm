...
Begin VB.Form frmStatmentOfAccounts 
   ...
   Begin VB.OptionButton Option1 
      Caption         =   "Grouping Printing «·ÿ»«⁄… »«·„Ã„Ê⁄« "
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   0
...
Dim dfrom As Date
Dim dto As Date
allword = "  „‰   «—ÌŒ   " & DatePart("yyyy", Format(dtpfrom.Value, "dd/mm/yyyy")) & "/" & DatePart("m", Format(dtpfrom.Value, "dd/mm/yyyy")) & "/" & DatePart("d", Format(dtpfrom.Value, "dd/mm/yyyy")) & "  ·€«Ì…  " & DatePart("yyyy", Format(dtpto.Value, "dd/mm/yyyy")) & "/" & DatePart("m", Format(dtpto.Value, "dd/mm/yyyy")) & "/" & DatePart("d", Format(dtpto.Value, "dd/mm/yyyy"))
'allword = "  „‰   «—ÌŒ   " & Format(dtpfrom.Value, "dd/mm/yyyy") & "  ·€«Ì…  " & Format(dtpto.Value, "dd/mm/yyyy")
a.caption = allword
End Sub
...
dataanu.com_statementofaccounts_Grouping cLogUserœ
