...
Begin VB.Form frminvoice 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label7 
         Alignment       =   1  'Right Justify
         BackStyle       =   0  'Transparent
         Caption         =   "Total Unpaid Amount «·—’Ìœ «·„ »ﬁÌ "
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   178
      ...
      Begin VB.Label l8 
         Alignment       =   1  'Right Justify
         BackStyle       =   0  'Transparent
         Caption         =   "Auto Distribute «·”œ«œ «· ·ﬁ«∆Ì "
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   178
   ...
   Begin VB.Label Label6 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Un Applied Amount  «·—’Ìœ «·€Ì— „” €· "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   178
   ...
   Begin VB.Menu xfile 
      ...
      Visible         =   0   'False
      Begin VB.Menu edit 
         Caption         =   "Edit Amount   ›«÷… «·„Ã„Ê⁄ "
      End
      Begin VB.Menu dash 
         Caption         =   "-"
      End
      Begin VB.Menu delete 
         Caption         =   "Delete Amount  «·€««¡ «·„Ã„Ê⁄ "
         Enabled         =   0   'False
      End
   End
End
...
If MsgBox("Are You Sure You Want to Cancel" & vbCrLf & " ø  Â· «‰  „ «ﬂœ ··«·€«¡", vbYesNo, "Conformation") = vbYes Then
    Timer1.Interval = 0
    Unload Me
End If
End Sub
...
If xx = 0 And rr = 0 Then
    Unload Me
    MsgBox "This Customer Have No Any Unpaid Invoice" & vbCrLf & "  ﬂ· «·›Ê« Ì— „œ›Ê⁄Â", vbInformation, "No Invoice"
End If
activeform = 2
End If
End Sub
...
If transferamount > Val(ListView1.ListItems(selectclick).ListSubItems(3).Text) Then
    MsgBox "Your Payment Amount Can not More Than the Unpaid Amount" & vbCrLf & " ·«Ì„ﬂ‰ «·œ›⁄ «ﬂÀ— „‰ «·„»·€ «·€Ì— «·„œ›Ê⁄", vbInformation, "Invalid Amount"
    Exit Sub
End If
...
If totalvalidatedebitamount > validatedebitamount Then ' validatedebitamount  is the first amount
    MsgBox "Please check Your Amount is More than Applicable Amount" & vbCrLf & "   «ﬂœ „‰ «·„œÌÊ‰ÌÂ ·«‰Â« «ﬂÀ— „‰ «·„œ›Ê⁄", vbInformation, "Amount Over flow"
    totalvalidatedebitamount = totalvalidatedebitamount - transferamount
    Exit Sub
End If
If transferamount > 0 Then 'this amount directly from the payment table
