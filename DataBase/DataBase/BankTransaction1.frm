...
Begin VB.Form BankTransaction1 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.CommandButton Command1 
         Caption         =   "Show Cash Deposit List... ⁄—÷ ﬁ«∆„… »«·«Ìœ«⁄«  «·‰ﬁœÌ…"
         Enabled         =   0   'False
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
      ...
      Begin VB.Label Label30 
         Caption         =   "Transaction Date        «—ÌŒ «·«Ìœ«⁄ "
         Enabled         =   0   'False
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   8.25
