VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} reporttax 
   Bindings        =   "reporttax.dsx":0000
   Caption         =   "Tax Reports"
   ClientHeight    =   11010
   ClientLeft      =   165
   ClientTop       =   555
   ...
   EndProperty
End
Attribute VB_Name = "reporttax"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
dataanu.rscommandtax.Requery
End Sub
